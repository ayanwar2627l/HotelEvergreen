      ...
      dishes: [
        {
          ...
          price: "₹150",
          description:
            "Traditional Bihar delicacy with roasted gram flour balls",
        },
        {
          name: "Sattu Paratha",
          price: "₹120",
          description: "Nutritious paratha stuffed with roasted gram flour",
        },
        {
          name: "Fish Curry",
          price: "₹300",
          description: "Fresh river fish in traditional Bihar style curry",
        },
        {
          name: "Kheer",
          price: "₹100",
    ...
    },
    {
      ...
      dishes: [
        ...
        },
        {
          name: "Tea/Coffee",
          price: "₹40",
          description: "Hot beverages served fresh",
        },
        {
          name: "Fresh Juices",
          price: "₹90",
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden w-full m-0 p-0">
        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-4 mt-8">
          ...
          <p className="text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto text-white/90 font-inter font-light animate-fade-in leading-relaxed drop-shadow-sm" style={{ animationDelay: "0.3s" }}>
            Savor authentic Bihari cuisine and multi-cuisine delights prepared with love and the finest ingredients. Experience the rich culinary heritage of Bihar.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-evergreen-100 mb-6">
              Enjoy our delicious food with convenient online ordering and
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-6">
              {paymentMethods.map((method) => (
                <Badge
                  key={method}
                  variant="secondary"
                  className="bg-white text-evergreen-600"
                >
                  {method}
                </Badge>
              ))}
          ...
          <Card className="p-8">
            <CardContent className="p-0">
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-gray-600">
                  We're here to serve you throughout the day
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="text-center">
                  ...
                  <div className="space-y-2 text-gray-600">
                    ...
                    <p>
                      <strong>Dinner:</strong> 7:00 PM - 11:00 PM
                    </p>
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <div className="space-y-2 text-gray-600">
                    <p>
                      <strong>Available:</strong> 24 Hours
                    </p>
                    <p>
                      <strong>Quick Service:</strong> 6:00 AM - 12:00 AM
                    </p>
                    <p>
                      <strong>Night Service:</strong> 12:00 AM - 6:00 AM
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 hero-gradient">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white mb-8">
            Contact us to place your order or make a reservation at our
            restaurant
          </p>
